        ...
        <div className="w-full h-full bg-slate-950 flex flex-col">
                    ...
                    <div className="flex gap-1 bg-slate-800 p-1 rounded-lg">
                        {(['cards', 'json'] as EditorTab[]).map((tab) => (
                            <button
                                ...
                                className={`px-4 py-1.5 text-xs font-bold uppercase rounded transition-all ${editorTab === tab
            ...
            <main className="flex-1 flex overflow-hidden">
                {editorTab === 'cards' ? (
                    <>
                        {/* Character List */}
                        <aside className="w-48 bg-slate-900 border-r border-slate-800 p-4 overflow-auto">
                            ...
                            {activeCharacter ? (
                                <div className="max-w-2xl">
                                    <div className="flex items-start gap-6 mb-6">
                                        <div className="w-32 h-40 bg-gradient-to-b from-slate-700 to-slate-800 rounded-xl flex items-center justify-center text-5xl">
                                            👤
                                        </div>
                                        <div>
                                    ...
                                    <div>
                                        ...
                                        <div className="grid grid-cols-2 gap-3">
                                            ...
                                            {Array.from({ length: 4 - activeCharacter.slots.abilityCardIds.length }).map((_, i) => (
                                                <div key={i} className="bg-slate-900 rounded-lg p-3 border border-dashed border-slate-700 flex items-center justify-center">
            ...
            <footer className="h-6 bg-slate-950 border-t border-slate-800 px-4 flex items-center justify-between text-[10px] font-mono text-slate-600 uppercase">
                ...
                <span>Statuses: {Object.keys(database.statuses).length}</span>
